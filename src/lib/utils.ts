    ...
    final_brief: {
      final_decision: {
        ...
        reasoning:
          ...
          `Connect ANALYZE_API_URL for live AI-powered analysis.`,
      ...
      executive_summary:
        ...
        `Connect the VentureMind backend (ANALYZE_API_URL) to receive a real verdict ` +
      ...
      key_findings: [
        "Demo mode is active — connect ANALYZE_API_URL to run the live 6-agent pipeline.",
