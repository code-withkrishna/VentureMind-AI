...
class LLMClient:
    ...
    def _should_retry(error: Exception) -> bool:
        ...
        return "429" in lowered or "rate limit" in lowered or "timed out" in lowered or "500" in lowered or "502" in lowered or "503" in lowered
